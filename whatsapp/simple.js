...
`.trim()
    ...
    sendText(jid, text, quoted) {
      return this.sendMessage(jid, text, MessageType.text, {quoted: quoted, contextInfo: { externalAdReply: { title: 'YUI Bot', "body": "multipurpose WhatsApp bot using baileys library!",thumbnailUrl: 'https://i.ibb.co/vkBfzZb/d219f542d15d.jpg', sourceUrl: 'https://github.com/Arya-was/' }}})
    }
     ...
     * @param {Object} quoted 
     */
    forward(jid, text, quoted) {
      return this.sendMessage(jid, text, MessageType.text, {quoted: quoted, contextInfo:{"forwardingScore":999,"isForwarded":true}})
    }
